    ...
    <div>
      ...
      <div>
        <p className="text-center text-secondary-500 text-lg leading-loose">
          جایی که قراره بتونی یک اپلیکیشن بلاگ کامل را مدیریت کنی!
          <br />بتونی بلاگ بسازی - کامنت بگذاری و در پنلت همه اتفات رو رصد کنی!
        </p>
        <div className="flex justify-center gap-x-8 w-full mt-8">
